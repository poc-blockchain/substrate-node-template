...
pub mod pallet {
    ...
    pub enum Event<T: Config> {
        ...
        /// A Kitty was successfully Bred. \[owner, parent#1,  parent#2, new_kitty_id\]
        Bred(T::AccountId, T::Hash, T::Hash, T::Hash),
    }
    ...
    impl<T: Config> Pallet<T> {
        ...
        Self::deposit_event(Event::Bred(sender, parent1, parent2, kitty_id));
